    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/service-driver-user?characterEncoding=utf-8&serverTimezone=GMT%2B8",
                ...
                .globalConfig(builder -> {
                    builder.author("JPP").fileOverride().outputDir("/Volumes/Work/WorkSpace/online-taxi-public/service-driver-user/src/main/java");
                })
                .packageConfig(builder -> {
                    builder.parent("com.mashibing.serviceDriverUser").pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                            "/Volumes/Work/WorkSpace/online-taxi-public/service-driver-user/src/main/java/com/mashibing/serviceDriverUser/mapper"));
                })
